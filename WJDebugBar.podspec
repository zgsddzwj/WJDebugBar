...
Pod::Spec.new do |s|
  s.name             = 'WJDebugBar'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WJDebugBar.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/adwardgc/WJDebugBar'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'adwardgc' => 'wangjian5@xin.com' }
  s.source           = { :git => 'https://github.com/adwardgc/WJDebugBar.git', :tag => s.version.to_s }
